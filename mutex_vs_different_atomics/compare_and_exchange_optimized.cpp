...
// Portable cache-line size: prefer the C++17 constant when the implementation
// provides it, otherwise fall back to 64 (typical on x86_64 and Apple Silicon;
// some ARM and POWER chips use 128).
...
// 2. fetch_add with relaxed (The Hardware-accelerated baseline) 
...
// 3. fetch_add with sequential consistency (The Hardware-accelerated baseline) 
